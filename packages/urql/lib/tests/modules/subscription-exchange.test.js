...
describe('subscriptionExchange', function () {
  ...
  it('ignores non-subscription operations', function () {
    ...
    var exchange = (0, _subscriptionExchange.subscriptionExchange)(createSubscription, forward);
    exchange({
      operationName: 'query'
    });
  ...
  it('creates a continuous exchange observable with a sub-observer', function (done) {
    ...
    var createSubscription = function createSubscription(operation, observer) {
      ...
      setTimeout(function () {
        ...
        expect(error).toHaveBeenCalledWith(new _error.CombinedError({
    ...
    var exchange = (0, _subscriptionExchange.subscriptionExchange)(createSubscription, null);
