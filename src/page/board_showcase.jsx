...
var BoardShowcase = React.createClass({
	...
	const TraceSpaceLink = props => zipUrl ? <a href={`https://tracespace.io/view/?boardUrl=${zipUrl}`} target="_blank" title="Open in Tracespace">{props.children}</a> : <div>{props.children}</div>
	return (
