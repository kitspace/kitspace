...
const MakingProductsMeetup = React.createClass({
  getInitialState() {
      ...
      <div>
        ...
        <semantic.Container style={{marginTop: 30}}>
          ...
          <p>
            ...
            hardware products. They provide networking and skills exchange
            between designers, engineers and local manufacturers. We have
            regular talks, workshops and social events.
          </p>
          <p>
            Sign up{' '}
          ...
          >
            ...
            <semantic.Form.Field>
              <label>Receive event announcements via email:</label>
              <input
                type="checkbox"
                name="subscribe"
                checked={this.state.subscribe}
                onClick={e => this.setState({subscribe: !this.state.subscribe})}
              />
            </semantic.Form.Field>
            <semantic.Form.Field>
              <label>
                Proposed Talk/Skillshare Title (about 50 characters, optional)
              </label>
              <input type="text" name="talk-title" />
            </semantic.Form.Field>
            <semantic.Form.Field>
              <label>Description (about 200 characters, optional)</label>
