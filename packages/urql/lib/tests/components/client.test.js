...
var _client2 = _interopRequireDefault(require("../../modules/client"));
...
describe('Client Component', function () {
  ...
  it('should return null with no render function', function () {
    // @ts-ignore
    var component = _reactTestRenderer.default.create(_react.default.createElement(_client.default, null));

    var tree = component.toJSON();
    expect(tree).toBeNull();
    component.update(_react.default.createElement(_client.default // @ts-ignore
    , {
      children: function children() {
        return _react.default.createElement("div", null, "hey");
      }
    }));
  ...
  it('should use the render prop when supplied and render the defaults', function (done) {
    // @ts-ignore
    var client = _reactTestRenderer.default.create(_react.default.createElement(_client.default // @ts-ignore
    , {
  ...
  it('should return the proper render prop arguments with a query supplied', function (done) {
    ...
    var clientModule = new _client2.default({
      url: 'test'
    });
    var result; // @ts-ignore

    var client = _reactTestRenderer.default.create(_react.default.createElement(_client.default, {
  ...
  it('should format new props', function (done) {
    ...
    client.update(_react.default.createElement(_client.default, {
      key: "test",
      client: clientModule // @ts-ignore
      ,
      query: {
  ...
  it('should format new mutations', function () {
    ...
    client.update(_react.default.createElement(_client.default // @ts-ignore
    , {
      key: "test",
      client: clientModule // @ts-ignore
      ,
  ...
  it('should hash queries and read from the cache', function () {
    var query = "\n      {\n        todos {\n          id\n          __typename\n        }\n      }\n    ";
    var formatted = (0, _typenames.formatTypeNames)({
      query: query,
      variables: {}
    });
    var hash = (0, _hash.hashString)(JSON.stringify(formatted));
    var clientModule = new _client2.default({
      url: 'test'
    });
  ...
  it('should handle subscriptions and return the proper render prop arguments', function () {
    ...
    var clientModule = new _client2.default({
      ...
      transformExchange: function transformExchange(x) {
        return (0, _subscriptionExchange.subscriptionExchange)(createSubscription, x);
      }
    });
    var result; // @ts-ignore
    ...
    expect(result.data).toBe(null);
    expect(result.error).toEqual(new _error.CombinedError({
